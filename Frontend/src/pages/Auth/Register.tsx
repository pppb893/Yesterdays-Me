    ...
    return (
        <div className="container" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '80vh' }}>
            <div className="glass-panel" style={{ width: '100%', maxWidth: '400px', padding: '32px' }}>
                <h2 style={{ color: 'hsl(0, 0%, 95%)', textAlign: 'center', marginBottom: '24px' }}>สร้างบัญชีใหม่</h2>
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                    ...
                    <div>
                        <label style={{ color: 'hsl(220, 15%, 65%)', fontSize: '0.9rem', marginBottom: '4px', display: 'block' }}>ยืนยันรหัสผ่าน</label>
                        <input
                            type="password"
